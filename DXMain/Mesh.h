...
public:
	...
	void AddMeshTexture( CTexture*);
	void SetMeshTexture(UINT index,  CTexture*);
	vector< CTexture*>& GetvMeshTexture() { return m_vMeshTexture; }
	//setter
	//animater mesh 선택을 표시하기 위한 함수
	void SetMeshMaterial( CMaterial* pMaterial);
	 CMaterial* GetMeshMaterial() { return m_pMeshMaterial; };
...
protected:
	...
	vector< CTexture*> m_vMeshTexture;
	 ...
	 CMaterial* m_pMeshMaterial{ nullptr };
	//topology
